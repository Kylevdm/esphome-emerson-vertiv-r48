...
static const uint32_t CAN_ID_RESPONSE_1 = 0x060F8003;  // Direct query response
static const uint32_t CAN_ID_RESPONSE_2 = 0x060F8007;  // Direct query response
static const uint32_t CAN_ID_BROADCAST = 0x0707F803;   // Continuous broadcast status
