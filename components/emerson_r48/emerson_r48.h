...
static const uint32_t CAN_ID_RESPONSE_1 = 0x0707F803;  // Changed from 0x060F8003
static const uint32_t CAN_ID_RESPONSE_2 = 0x0707F803;  // Changed from 0x060F8007 (might be same ID)
